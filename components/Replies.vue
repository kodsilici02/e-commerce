<template>
  <div class="w-full flex flex-wrap gap-0">
    <button
      @click="toggle"
      class="w-fit flex justify-center items-center gap-2 cursor-pointer transition-all duration-300 category-button hover:text-[var(--secondary)]">
      <div class="flex-1 flex-grow flex justify-center text-lg font-bold">
    ...
    <div class="w-full overflow-hidden transition-all duration-300" style="max-height: 0" ref="sub_category">
      <div class="sub-category">
        ...
        <div class="w-full flex gap-1 items-center">
          <div class="h-10 w-10 relative self-start">
            <img :src="auth.profilePhoto" class="w-full h-full rounded-full object-cover object-center" />
          </div>
          <div class="flex-1 flex flex-col">
            <div class="w-full text-base font-bold" style="color: var(--text-color)">Ananas Okan</div>
